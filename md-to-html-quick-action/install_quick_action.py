...
WORKFLOW_NAME = "Markdown 转 HTML（含图表）.workflow"
MENU_TITLE = "Markdown 转 HTML（含图表）"
        ...
        "actions": [
            {
                "action": {
                    ...
                    "InputUUID": "4BA8F001-C145-4E78-9EC4-20BB46CE6F0A",
                    "isViewVisible": 1,
                    "Keywords": ["HTML", "Markdown", "Export", "Browser"],
                    "location": "309.000000:305.000000",
                    "nibPath": "/System/Library/Automator/Run Shell Script.action/Contents/Resources/Base.lproj/main.nib",
                    "OutputUUID": "30B9AA69-FC99-4BA4-9C2C-BDF18AB66D45",
                    "UnlocalizedApplications": ["Automator"],
                    "UUID": "D4B69E3D-D8FB-4410-BDCA-98B7F318AF5B",
                },
                "isViewVisible": 1,
            }
        ],
...
def main() -> int:
    ...
    converter_path = tool_dir / "convert_md_to_html.sh"
